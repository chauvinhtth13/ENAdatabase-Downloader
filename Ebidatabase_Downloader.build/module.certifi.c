...
static PyObject *const_str_digest_77d61864536e8716a6a13162bb1c47b5;
...
{
    const_str_digest_e3372279ac622bcc524449ecfa1e730a = UNSTREAM_STRING( &constant_bin[ 89732 ], 16, 0 );
    const_str_digest_bf104775bcbaaed242cd21e69e0103fd = UNSTREAM_STRING( &constant_bin[ 89748 ], 19, 0 );
    const_str_digest_77d61864536e8716a6a13162bb1c47b5 = UNSTREAM_STRING( &constant_bin[ 89767 ], 10, 0 );
    const_tuple_d79f3178d0d84513e62fb2e3c969625e_tuple = PyTuple_New( 2 );
    const_str_plain_NUITKA_PACKAGE_certifi = UNSTREAM_STRING( &constant_bin[ 89777 ], 22, 1 );
...
static PyCodeObject *codeobj_b32fe28790390ad9a3a15fa8108f4646;

static void createModuleCodeObjects(void)
{
    module_filename_obj = MAKE_RELATIVE_PATH( const_str_digest_bf104775bcbaaed242cd21e69e0103fd );
    codeobj_b32fe28790390ad9a3a15fa8108f4646 = MAKE_CODEOBJ( module_filename_obj, const_str_digest_e3372279ac622bcc524449ecfa1e730a, 1, const_tuple_empty, 0, CO_NOFREE );
}
...
// doesn't automatically enter "sys.modules", so do it manually.
    ...
    struct Nuitka_FrameObject *frame_b32fe28790390ad9a3a15fa8108f4646;
    ...
    // Frame without reuse.
    frame_b32fe28790390ad9a3a15fa8108f4646 = MAKE_MODULE_FRAME( codeobj_b32fe28790390ad9a3a15fa8108f4646, module_certifi );

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack( frame_b32fe28790390ad9a3a15fa8108f4646 );
    assert( Py_REFCNT( frame_b32fe28790390ad9a3a15fa8108f4646 ) == 2 );

    // Framed code:
    tmp_assign_source_3 = PyList_New( 2 );
    frame_b32fe28790390ad9a3a15fa8108f4646->m_frame.f_lineno = 1;
    {
    ...
    UPDATE_STRING_DICT1( moduledict_certifi, (Nuitka_StringObject *)const_str_plain_where, tmp_assign_source_4 );

    // Restore frame exception if necessary.
#if 0
    RESTORE_FRAME_EXCEPTION( frame_b32fe28790390ad9a3a15fa8108f4646 );
#endif
    popFrameStack();

    assertFrameObject( frame_b32fe28790390ad9a3a15fa8108f4646 );
    ...
    {
        exception_tb = MAKE_TRACEBACK( frame_b32fe28790390ad9a3a15fa8108f4646, exception_lineno );
    }
    else if ( exception_tb->tb_frame != &frame_b32fe28790390ad9a3a15fa8108f4646->m_frame )
    {
        exception_tb = ADD_TRACEBACK( exception_tb, frame_b32fe28790390ad9a3a15fa8108f4646, exception_lineno );
    }
    ...
    tmp_assign_source_5 = const_str_digest_77d61864536e8716a6a13162bb1c47b5;
    UPDATE_STRING_DICT0( moduledict_certifi, (Nuitka_StringObject *)const_str_plain___version__, tmp_assign_source_5 );
