...
static void createModuleConstants( void )
{
    ...
    const_str_digest_c79c7700f135ad30b3dbd4b96a4a8fef = UNSTREAM_STRING( &constant_bin[ 680867 ], 53, 1 );
    ...
    const_str_digest_50be226755fb35a1992c4b8f94050655 = UNSTREAM_STRING( &constant_bin[ 680920 ], 47, 0 );
    const_str_digest_a64a95a9c42fa194ebf8f66a2097c7b9 = UNSTREAM_STRING( &constant_bin[ 680967 ], 25, 0 );
    ...
    const_str_digest_7efb23ea7fe90165406d93b36878c5a4 = UNSTREAM_STRING( &constant_bin[ 680974 ], 18, 0 );
    const_str_digest_94575176bfdfd162a38b08d2ac17d77f = UNSTREAM_STRING( &constant_bin[ 680992 ], 50, 0 );
...
static PyCodeObject *codeobj_5e338df2aa3e33cd24a7ab15f7e232cf;

static void createModuleCodeObjects(void)
{
    module_filename_obj = MAKE_RELATIVE_PATH( const_str_digest_94575176bfdfd162a38b08d2ac17d77f );
    codeobj_5e338df2aa3e33cd24a7ab15f7e232cf = MAKE_CODEOBJ( module_filename_obj, const_str_digest_50be226755fb35a1992c4b8f94050655, 1, const_tuple_empty, 0, CO_NOFREE | CO_FUTURE_DIVISION | CO_FUTURE_ABSOLUTE_IMPORT | CO_FUTURE_PRINT_FUNCTION );
}
...
// doesn't automatically enter "sys.modules", so do it manually.
    ...
    struct Nuitka_FrameObject *frame_5e338df2aa3e33cd24a7ab15f7e232cf;
    ...
    // Frame without reuse.
    frame_5e338df2aa3e33cd24a7ab15f7e232cf = MAKE_MODULE_FRAME( codeobj_5e338df2aa3e33cd24a7ab15f7e232cf, module_cryptography$hazmat$primitives$ciphers );

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack( frame_5e338df2aa3e33cd24a7ab15f7e232cf );
    assert( Py_REFCNT( frame_5e338df2aa3e33cd24a7ab15f7e232cf ) == 2 );

    // Framed code:
    tmp_assign_source_3 = PyList_New( 5 );
    frame_5e338df2aa3e33cd24a7ab15f7e232cf->m_frame.f_lineno = 1;
    {
    ...
    frame_5e338df2aa3e33cd24a7ab15f7e232cf->m_frame.f_lineno = 5;
    ...
    frame_5e338df2aa3e33cd24a7ab15f7e232cf->m_frame.f_lineno = 7;
...
#if 0
    RESTORE_FRAME_EXCEPTION( frame_5e338df2aa3e33cd24a7ab15f7e232cf );
#endif
    popFrameStack();

    assertFrameObject( frame_5e338df2aa3e33cd24a7ab15f7e232cf );
    ...
    {
        exception_tb = MAKE_TRACEBACK( frame_5e338df2aa3e33cd24a7ab15f7e232cf, exception_lineno );
    }
    else if ( exception_tb->tb_frame != &frame_5e338df2aa3e33cd24a7ab15f7e232cf->m_frame )
    {
        exception_tb = ADD_TRACEBACK( exception_tb, frame_5e338df2aa3e33cd24a7ab15f7e232cf, exception_lineno );
    }
