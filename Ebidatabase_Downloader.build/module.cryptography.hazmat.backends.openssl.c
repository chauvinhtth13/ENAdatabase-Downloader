...
{
    const_str_digest_ed08619aa512a47f7df697e4d0825920 = UNSTREAM_STRING( &constant_bin[ 644985 ], 23, 0 );
    const_tuple_015ce367c9d8c99a6c1b277f992aea27_tuple = PyTuple_New( 2 );
    const_str_digest_5e8eca5ba1f5be4bfdd91ed03517c098 = UNSTREAM_STRING( &constant_bin[ 645008 ], 51, 1 );
    ...
    const_str_digest_2cd01991aeef67eb788a10e72d6b96ed = UNSTREAM_STRING( &constant_bin[ 645059 ], 48, 0 );
    ...
    const_str_digest_a45608b8763b539a26fb93c231bacdc3 = UNSTREAM_STRING( &constant_bin[ 644992 ], 16, 0 );
    const_str_digest_10ecbd5aa553ee5b6e6286098d512ce1 = UNSTREAM_STRING( &constant_bin[ 645107 ], 45, 0 );
...
static PyCodeObject *codeobj_ce5f68b01da18cd05d7d4f4a6f2b1112;

static void createModuleCodeObjects(void)
{
    module_filename_obj = MAKE_RELATIVE_PATH( const_str_digest_2cd01991aeef67eb788a10e72d6b96ed );
    codeobj_ce5f68b01da18cd05d7d4f4a6f2b1112 = MAKE_CODEOBJ( module_filename_obj, const_str_digest_10ecbd5aa553ee5b6e6286098d512ce1, 1, const_tuple_empty, 0, CO_NOFREE | CO_FUTURE_DIVISION | CO_FUTURE_ABSOLUTE_IMPORT | CO_FUTURE_PRINT_FUNCTION );
}
...
// doesn't automatically enter "sys.modules", so do it manually.
    ...
    struct Nuitka_FrameObject *frame_ce5f68b01da18cd05d7d4f4a6f2b1112;
    ...
    // Frame without reuse.
    frame_ce5f68b01da18cd05d7d4f4a6f2b1112 = MAKE_MODULE_FRAME( codeobj_ce5f68b01da18cd05d7d4f4a6f2b1112, module_cryptography$hazmat$backends$openssl );

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack( frame_ce5f68b01da18cd05d7d4f4a6f2b1112 );
    assert( Py_REFCNT( frame_ce5f68b01da18cd05d7d4f4a6f2b1112 ) == 2 );

    // Framed code:
    tmp_assign_source_3 = PyList_New( 5 );
    frame_ce5f68b01da18cd05d7d4f4a6f2b1112->m_frame.f_lineno = 1;
    {
    ...
    frame_ce5f68b01da18cd05d7d4f4a6f2b1112->m_frame.f_lineno = 5;
    ...
    frame_ce5f68b01da18cd05d7d4f4a6f2b1112->m_frame.f_lineno = 7;
...
#if 0
    RESTORE_FRAME_EXCEPTION( frame_ce5f68b01da18cd05d7d4f4a6f2b1112 );
#endif
    popFrameStack();

    assertFrameObject( frame_ce5f68b01da18cd05d7d4f4a6f2b1112 );
    ...
    {
        exception_tb = MAKE_TRACEBACK( frame_ce5f68b01da18cd05d7d4f4a6f2b1112, exception_lineno );
    }
    else if ( exception_tb->tb_frame != &frame_ce5f68b01da18cd05d7d4f4a6f2b1112->m_frame )
    {
        exception_tb = ADD_TRACEBACK( exception_tb, frame_ce5f68b01da18cd05d7d4f4a6f2b1112, exception_lineno );
    }
