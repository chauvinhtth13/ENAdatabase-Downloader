...
NUITKA_CROSS_MODULE PyObject *impl___internal__$$$function_7_complex_call_helper_keywords_star_dict( PyObject **python_pars )
{
    ...
    loop_start_1:;
    // Tried code:
    tmp_value_name_1 = tmp_dict_1__iter;
    ...
    // End of try:
    try_end_2:;
    tmp_compare_left_4 = tmp_dict_1__key_xxx;
    ...
    loop_start_2:;
    // Tried code:
    tmp_value_name_2 = tmp_dict_2__iter;
...
NUITKA_CROSS_MODULE PyObject *impl___internal__$$$function_8_complex_call_helper_pos_star_list( PyObject **python_pars )
{
    ...
    goto try_return_handler_1;
    // tried codes exits in all cases
    NUITKA_CANNOT_GET_HERE( __internal__$$$function_8_complex_call_helper_pos_star_list );
    return NULL;
    // Return handler code:
    try_return_handler_1:;
    CHECK_OBJECT( (PyObject *)par_called );
