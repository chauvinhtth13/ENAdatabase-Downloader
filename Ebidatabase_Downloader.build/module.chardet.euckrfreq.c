...
{
    const_str_digest_cc56906e074538d0ada7e776069ec64d = UNSTREAM_STRING( &constant_bin[ 126934 ], 17, 0 );
    const_tuple_fb1a7aca64de80b2dca943d3e5efe888_tuple = PyMarshal_ReadObjectFromString( (char *)&constant_bin[ 126951 ], 11765 );
    const_float_6_0 = UNSTREAM_FLOAT( &constant_bin[ 138716 ] );
    const_int_pos_2352 = PyInt_FromLong( 2352l );
    const_str_digest_48132b9e4f2ee8e31888e168d2dd5ac8 = UNSTREAM_STRING( &constant_bin[ 138724 ], 20, 0 );
...
#ifdef _NUITKA_TRACE
    puts("chardet.euckrfreq: Calling setupMetaPathBasedLoader().");
#endif
