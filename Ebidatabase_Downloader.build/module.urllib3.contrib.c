...
{
    const_str_plain_NUITKA_PACKAGE_urllib3_contrib = UNSTREAM_STRING( &constant_bin[ 1046243 ], 30, 1 );
    ...
    const_str_digest_3df598d8cefc3c5742fce0105830c8d4 = UNSTREAM_STRING( &constant_bin[ 1046273 ], 27, 0 );
    const_str_digest_6975fd07d5b5e85a18ab2ed197d08f84 = UNSTREAM_STRING( &constant_bin[ 1046300 ], 24, 0 );
...
static PyCodeObject *codeobj_5ed558c537dd31ab13f3667c866de7ff;

static void createModuleCodeObjects(void)
{
    module_filename_obj = MAKE_RELATIVE_PATH( const_str_digest_3df598d8cefc3c5742fce0105830c8d4 );
    codeobj_5ed558c537dd31ab13f3667c866de7ff = MAKE_CODEOBJ( module_filename_obj, const_str_digest_6975fd07d5b5e85a18ab2ed197d08f84, 1, const_tuple_empty, 0, CO_NOFREE );
}
...
#ifdef _NUITKA_TRACE
    puts("urllib3.contrib: Calling setupMetaPathBasedLoader().");
#endif
...
// doesn't automatically enter "sys.modules", so do it manually.
    ...
    struct Nuitka_FrameObject *frame_5ed558c537dd31ab13f3667c866de7ff;
    ...
    // Frame without reuse.
    frame_5ed558c537dd31ab13f3667c866de7ff = MAKE_MODULE_FRAME( codeobj_5ed558c537dd31ab13f3667c866de7ff, module_urllib3$contrib );

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack( frame_5ed558c537dd31ab13f3667c866de7ff );
    assert( Py_REFCNT( frame_5ed558c537dd31ab13f3667c866de7ff ) == 2 );

    // Framed code:
    tmp_assign_source_3 = PyList_New( 3 );
    frame_5ed558c537dd31ab13f3667c866de7ff->m_frame.f_lineno = 1;
    {
...
#if 0
    RESTORE_FRAME_EXCEPTION( frame_5ed558c537dd31ab13f3667c866de7ff );
#endif
    popFrameStack();

    assertFrameObject( frame_5ed558c537dd31ab13f3667c866de7ff );
    ...
    {
        exception_tb = MAKE_TRACEBACK( frame_5ed558c537dd31ab13f3667c866de7ff, exception_lineno );
    }
    else if ( exception_tb->tb_frame != &frame_5ed558c537dd31ab13f3667c866de7ff->m_frame )
    {
        exception_tb = ADD_TRACEBACK( exception_tb, frame_5ed558c537dd31ab13f3667c866de7ff, exception_lineno );
    }
