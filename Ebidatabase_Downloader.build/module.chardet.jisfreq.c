...
{
    const_str_digest_ea9ca92ff482b90cfb7ad9a3c895c6d4 = UNSTREAM_STRING( &constant_bin[ 185126 ], 15, 0 );
    const_int_pos_4368 = PyInt_FromLong( 4368l );
    const_tuple_435ed3830ae955262dd096d82966c5a6_tuple = PyMarshal_ReadObjectFromString( (char *)&constant_bin[ 185141 ], 21845 );
    const_str_digest_6b745b4160f9a82f1177a6df878cc007 = UNSTREAM_STRING( &constant_bin[ 206986 ], 18, 0 );
...
#ifdef _NUITKA_TRACE
    puts("chardet.jisfreq: Calling setupMetaPathBasedLoader().");
#endif
