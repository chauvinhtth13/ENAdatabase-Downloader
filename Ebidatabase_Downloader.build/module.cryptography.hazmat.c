...
{
    const_str_digest_072f50675723127f2a186a841529ed33 = UNSTREAM_STRING( &constant_bin[ 639098 ], 19, 0 );
    const_str_digest_f6a5cc0cba3d9495847f9ca96ef756af = UNSTREAM_STRING( &constant_bin[ 639117 ], 28, 0 );
    const_str_digest_27db60f38c2a8b82e7dce2c1d9120fa2 = UNSTREAM_STRING( &constant_bin[ 639145 ], 31, 0 );
    const_str_plain_hazmat = UNSTREAM_STRING( &constant_bin[ 53524 ], 6, 1 );
    const_str_digest_2a39f05ed9e139c2a8e2a9a699f4a074 = UNSTREAM_STRING( &constant_bin[ 639176 ], 231, 0 );
...
static PyCodeObject *codeobj_0f0a9e02f20a23a73ed3080b12656a42;

static void createModuleCodeObjects(void)
{
    module_filename_obj = MAKE_RELATIVE_PATH( const_str_digest_27db60f38c2a8b82e7dce2c1d9120fa2 );
    codeobj_0f0a9e02f20a23a73ed3080b12656a42 = MAKE_CODEOBJ( module_filename_obj, const_str_digest_f6a5cc0cba3d9495847f9ca96ef756af, 1, const_tuple_empty, 0, CO_NOFREE | CO_FUTURE_DIVISION | CO_FUTURE_ABSOLUTE_IMPORT | CO_FUTURE_PRINT_FUNCTION );
}
...
// doesn't automatically enter "sys.modules", so do it manually.
    ...
    struct Nuitka_FrameObject *frame_0f0a9e02f20a23a73ed3080b12656a42;
    ...
    // Frame without reuse.
    frame_0f0a9e02f20a23a73ed3080b12656a42 = MAKE_MODULE_FRAME( codeobj_0f0a9e02f20a23a73ed3080b12656a42, module_cryptography$hazmat );

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack( frame_0f0a9e02f20a23a73ed3080b12656a42 );
    assert( Py_REFCNT( frame_0f0a9e02f20a23a73ed3080b12656a42 ) == 2 );

    // Framed code:
    tmp_assign_source_3 = PyList_New( 3 );
    frame_0f0a9e02f20a23a73ed3080b12656a42->m_frame.f_lineno = 1;
    {
    ...
    frame_0f0a9e02f20a23a73ed3080b12656a42->m_frame.f_lineno = 11;
...
#if 0
    RESTORE_FRAME_EXCEPTION( frame_0f0a9e02f20a23a73ed3080b12656a42 );
#endif
    popFrameStack();

    assertFrameObject( frame_0f0a9e02f20a23a73ed3080b12656a42 );
    ...
    {
        exception_tb = MAKE_TRACEBACK( frame_0f0a9e02f20a23a73ed3080b12656a42, exception_lineno );
    }
    else if ( exception_tb->tb_frame != &frame_0f0a9e02f20a23a73ed3080b12656a42->m_frame )
    {
        exception_tb = ADD_TRACEBACK( exception_tb, frame_0f0a9e02f20a23a73ed3080b12656a42, exception_lineno );
    }
